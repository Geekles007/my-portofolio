...
const PageStater = ({handleTitleChange}: PageStaterProps) => {
    ...
    return <PageStaterWrapper>
        <div className={"state-list"}>
            <Link activeClass="activated" to="hello" spy={true} isDynamic={true} smooth={true} offset={-10} duration={500} onSetActive={() => handleTitleChange("Introduction")} className={"li"}><span>Introduce</span></Link>
            <Link activeClass="activated" to="about-me" spy={true} smooth={true} offset={-10} duration={500} onSetActive={() => handleTitleChange("About me")} className={"li"}><span>About me</span></Link>
